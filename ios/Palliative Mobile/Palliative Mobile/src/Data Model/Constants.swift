...
// GLOBAL OBJECTS
let web = WebInterface()      // These are global references
let db = DBInterface()        // to the web and database APIs

// PAGE ID CONSTANTS
let kRapidPCPageID = 2              // These pages can
let kCareForFrailPageID = 53        // be reached from
let kDeathResusPageID = 390         // the home page of
let kCommonSymptomsPageID = 169     // the application.

let kSeattlePageID = 19
let kNewYorkPageID = 20
let kKarnofskyPageID = 79           // These are the pages
let kAustraliaPageID = 29           // considered "special",
let kPrognosticPageID = 30          // such as various
let kPerformancePageID = 31         // calculator pages,
let kECOGPageID = 36                // that required specific
let kTrajectoryPageID = 67          // treatment.
...
let kPrognosticSegueID = "toPrognostic"         // Calculator segues
...
let kRapidPCSegueID = "toRapidPC"           // Main app segues
...
// Recognizes a special page ID and provides the corresponding segue ID
